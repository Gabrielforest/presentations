...
\center {\scriptsize {\color{blue}Figura 8}: Probabilidade de ocorrência da Bertholletia excelsa numa escala de 0 a 1000 adequadas para a modelagem a 2.5 arco minutos usando a filtragem geográfica.}
...
\center {\scriptsize {\color{blue}Figura 11}: Modelo usando filtragem geográfica + ambiental a 2.5 arco minutos, e suas projeções futuras nos cenários SSP245 e SSP585 para o período médio de 2050.}
